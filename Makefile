...
export PYTHON3_PACKAGES=pip wheel numpy cython futures \
	...
	xgboost xlrd \
	pysam htseq macs2 deeptools micca htsget pyega3 gtdbtk run-dbcan synapseclient macs3
...
export PERL_CPANM=App::Cmd::Setup App::cpanoutdated Bio::DB::Taxonomy Bio::Perl Bio::Roary \
	...
	Alien::Build Log::Log4perl YAML PAR::Dist CPAN::DistnameInfo inc::latest Module::Build Set::IntervalTree DBI DB_File URI Archive::Zip Set::IntervalTree PerlIO::gzip Bio::DB::BigFile Set::IntervalTree JSON::XS Test::Warnings
...
apt-install:
	APTS="ant apache2 apt-file aptitude artemis auditd augustus autoconf bamtools baobab \
		...
		vsearch wakeonlan x11-utils zlib1g zlib1g-dev zlibc iqtree clang-tidy libpll-dev awscli vcftools git-lfs lolcat cowsay fortune cpanminus nmap mariadb-server fail2ban snakemake meryl libbam-dev libsam-dev xclip tcptrack bmon"
